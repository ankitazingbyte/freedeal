...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { description: @deal.description, image: @deal.image, title: @deal.title } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { description: @deal.description, image: @deal.image, title: @deal.title } }
