...
class Product3sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product3" do
    assert_difference('Product3.count') do
      post product3s_url, params: { product3: { image: @product3.image, title: @product3.title, url: @product3.url } }
    end
  ...
  test "should update product3" do
    patch product3_url(@product3), params: { product3: { image: @product3.image, title: @product3.title, url: @product3.url } }
